...
/* ─── SUPABASE CLIENT ─────────────────────────────────────────────────────── */
// ⚠️ შეცვალე შენი პროექტის URL და anon key-ით
...
function getRoleLabel(user) { return ROLE_LABELS[normalizeRole(user)] || "მოთამაშე"; }
function getRoleColor(user) { return ROLE_COLORS[normalizeRole(user)] || "oklch(0.75 0.03 270)"; }
...
const injectForumStyles = () => {
  ...
  style.textContent = `
    ...
    @keyframes grlPulse { 0%, 100% { opacity: 1; } 50% { opacity: 0.6; } }
    ...
    .grl-forum-root .grl-cv-badge {
      ...
      color: #fff; box-shadow: 0 0 16px oklch(0.55 0.22 155 / 0.35);
    }
    ...
    .grl-forum-root .grl-vacancy-badge {
      ...
      color: #fff; box-shadow: 0 0 16px var(--grl-primary-glow);
    }
    ...
    .grl-forum-root .grl-category-block {
      ...
      overflow: hidden; background: var(--grl-card);
      backdrop-filter: blur(16px); margin-bottom: 1.25rem;
      transition: all 0.3s ease;
      animation: grlFadeUp 0.5s cubic-bezier(0.22, 1, 0.36, 1) both;
    }
    .grl-forum-root .grl-category-block:hover { border-color: oklch(0.72 0.22 0 / 0.25); box-shadow: 0 8px 32px oklch(0 0 0 / 0.3); }
    .grl-forum-root .grl-category-block--vacancy { border-color: oklch(0.72 0.22 0 / 0.3); }
    .grl-forum-root .grl-category-block--vacancy .grl-category-header { background: linear-gradient(to right, oklch(0.72 0.22 0 / 0.08), oklch(0.78 0.14 220 / 0.04)); }
    ...
    .grl-forum-root .grl-category-header {
      ...
      border-bottom: 1px solid var(--grl-border); transition: all 0.3s ease;
    }
    .grl-forum-root .grl-category-header:hover { background: linear-gradient(to right, oklch(0.72 0.22 0 / 0.10), oklch(0.72 0.22 0 / 0.02)); }
    .grl-forum-root .grl-category-title { font-size: 1.05rem; font-weight: 700; color: oklch(0.97 0.005 250); font-family: var(--grl-font-sans); display: flex; align-items: center; gap: 0.5rem; }
    ...
    .grl-forum-root .grl-subforum-row:hover { background: oklch(0.72 0.22 0 / 0.04); border-color: oklch(0.72 0.22 0 / 0.15); }
    .grl-forum-root .grl-subforum-row::before { content: ""; position: absolute; left: 0; top: 0; bottom: 0; width: 3px; background: transparent; transition: background 0.4s ease; }
    .grl-forum-root .grl-subforum-row:hover::before { background: linear-gradient(to bottom, var(--grl-primary), oklch(0.60 0.26 330)); }
    .grl-forum-root .grl-subforum-row--vacancy:hover::before { background: linear-gradient(to bottom, var(--grl-primary), var(--grl-cyan)); }
    ...
    .grl-forum-root .grl-subforum-icon-wrap {
      ...
      border: 1px solid oklch(0.72 0.22 0 / 0.15); color: var(--grl-primary); transition: all 0.4s ease;
    }
    .grl-forum-root .grl-subforum-row--vacancy .grl-subforum-icon-wrap { background: linear-gradient(135deg, oklch(0.72 0.22 0 / 0.14), oklch(0.78 0.14 220 / 0.10)); border-color: oklch(0.72 0.22 0 / 0.2); }
    .grl-forum-root .grl-subforum-row:hover .grl-subforum-icon-wrap { background: linear-gradient(135deg, var(--grl-primary), oklch(0.60 0.26 330)); color: #fff; transform: scale(1.05); box-shadow: 0 0 30px var(--grl-primary-glow); }
    .grl-forum-root .grl-subforum-row--vacancy:hover .grl-subforum-icon-wrap { background: linear-gradient(135deg, var(--grl-primary), var(--grl-cyan)); box-shadow: 0 0 30px var(--grl-primary-glow); }

    .grl-forum-root .grl-subforum-name { font-size: 0.875rem; font-weight: 700; color: oklch(0.97 0.005 250); display: flex; align-items: center; flex-wrap: wrap; gap: 0.3rem; }
    .grl-forum-root .grl-subforum-sub { font-size: 0.65rem; color: var(--grl-muted-foreground); margin-top: 0.15rem; display: flex; align-items: center; gap: 0.4rem; }

    .grl-forum-root .grl-stat-col { text-align: center; min-width: 65px; }
    .grl-forum-root .grl-stat-num { font-size: 0.875rem; font-weight: 700; color: oklch(0.97 0.005 250); font-family: var(--grl-font-mono); }
    .grl-forum-root .grl-stat-label { font-size: 0.5rem; text-transform: uppercase; letter-spacing: 0.12em; color: var(--grl-muted-foreground); font-weight: 600; margin-top: 0.1rem; }

    .grl-forum-root .grl-last-post-col { display: flex; align-items: center; gap: 0.625rem; min-width: 170px; max-width: 200px; }
    .grl-forum-root .grl-last-post-avatar { width: 32px; height: 32px; border-radius: 50%; flex-shrink: 0; display: flex; align-items: center; justify-content: center; color: #fff; font-size: 0.7rem; font-weight: 700; transition: transform 0.3s ease; }
    .grl-forum-root .grl-subforum-row:hover .grl-last-post-avatar { transform: scale(1.05); }
    .grl-forum-root .grl-last-post-title { font-size: 0.65rem; font-weight: 700; color: oklch(0.95 0.005 250); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 120px; display: block; }
    .grl-forum-root .grl-last-post-meta { font-size: 0.55rem; color: var(--grl-muted-foreground); margin-top: 0.1rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 120px; display: block; }

    .grl-forum-root .grl-input { width: 100%; background-color: oklch(0.18 0.025 285 / 0.6); border: 1px solid var(--grl-border); border-radius: 0.75rem; padding: 0.75rem 1rem; font-size: 0.875rem; color: var(--grl-foreground); font-family: var(--grl-font-sans); outline: none; transition: all 0.3s ease; }
    .grl-forum-root .grl-input::placeholder { color: oklch(0.68 0.025 270 / 0.6); }
    .grl-forum-root .grl-input:focus { border-color: var(--grl-primary); box-shadow: 0 0 0 4px oklch(0.72 0.22 0 / 0.12); background-color: oklch(0.20 0.025 285 / 0.6); }
    .grl-forum-root textarea.grl-input { resize: none; }

    .grl-forum-root .grl-cv-form { background: oklch(0.55 0.20 155 / 0.06); border: 1px solid oklch(0.55 0.20 155 / 0.25); border-radius: 1rem; padding: 1.25rem; }
    .grl-forum-root .grl-cv-field { display: flex; flex-direction: column; gap: 0.3rem; margin-bottom: 0.875rem; }
    .grl-forum-root .grl-cv-field:last-child { margin-bottom: 0; }

    .grl-forum-root .grl-btn { display: inline-flex; align-items: center; justify-content: center; gap: 0.5rem; border-radius: 0.75rem; font-family: var(--grl-font-sans); font-weight: 800; font-size: 0.8rem; cursor: pointer; transition: all 0.3s ease; border: none; outline: none; position: relative; overflow: hidden; }
    .grl-forum-root .grl-btn-primary { background: linear-gradient(135deg, var(--grl-primary), oklch(0.60 0.26 330)); color: #fff; padding: 0.75rem 1.5rem; box-shadow: 0 4px 24px var(--grl-primary-glow); }
    .grl-forum-root .grl-btn-primary:hover { transform: translateY(-2px) scale(1.02); box-shadow: 0 8px 40px var(--grl-primary-glow); }
    .grl-forum-root .grl-btn-primary:active { transform: scale(0.98); }
    .grl-forum-root .grl-btn-vacancy { background: linear-gradient(135deg, var(--grl-primary), var(--grl-cyan)); color: #fff; padding: 0.75rem 1.5rem; box-shadow: 0 4px 24px var(--grl-primary-glow); }
    .grl-forum-root .grl-btn-vacancy:hover { transform: translateY(-2px) scale(1.02); box-shadow: 0 8px 40px var(--grl-primary-glow); }
    .grl-forum-root .grl-btn-cv { background: linear-gradient(135deg, oklch(0.58 0.20 155), oklch(0.48 0.18 175)); color: #fff; padding: 0.75rem 1.5rem; box-shadow: 0 4px 24px oklch(0.55 0.20 155 / 0.4); }
    .grl-forum-root .grl-btn-cv:hover { transform: translateY(-2px) scale(1.02); box-shadow: 0 8px 40px oklch(0.55 0.20 155 / 0.5); }
    .grl-forum-root .grl-btn-ghost { background-color: oklch(0.18 0.025 285 / 0.6); color: var(--grl-foreground); border: 1px solid var(--grl-border); padding: 0.75rem 1.25rem; }
    .grl-forum-root .grl-btn-ghost:hover { background-color: var(--grl-muted); border-color: var(--grl-primary); transform: translateY(-1px); }
    .grl-forum-root .grl-btn-outline-primary { background: oklch(0.72 0.22 0 / 0.08); color: var(--grl-primary); border: 1px solid oklch(0.72 0.22 0 / 0.3); padding: 0.625rem 1.5rem; }
    .grl-forum-root .grl-btn-outline-primary:hover { background: linear-gradient(135deg, var(--grl-primary), oklch(0.60 0.26 330)); color: #fff; border-color: transparent; transform: translateY(-2px); box-shadow: 0 8px 32px var(--grl-primary-glow); }
    ...
    .grl-forum-root .grl-btn-danger { display: inline-flex; align-items: center; gap: 0.375rem; color: oklch(0.72 0.23 25); background: oklch(0.65 0.24 25 / 0.1); border: 1px solid oklch(0.65 0.24 25 / 0.3); padding: 0.3rem 0.7rem; border-radius: 0.5rem; font-size: 0.7rem; font-weight: 700; cursor: pointer; transition: all 0.3s ease; }
    .grl-forum-root .grl-btn-danger:hover { background: oklch(0.65 0.24 25 / 0.2); border-color: oklch(0.65 0.24 25 / 0.6); transform: scale(1.05); }
    .grl-forum-root .grl-btn-like { display: inline-flex; align-items: center; gap: 0.375rem; padding: 0.3rem 0.7rem; border-radius: 0.5rem; border: 1px solid var(--grl-border); font-size: 0.7rem; font-weight: 700; cursor: pointer; transition: all 0.3s ease; background: var(--grl-card); color: var(--grl-muted-foreground); }
    .grl-forum-root .grl-btn-like:hover { color: var(--grl-primary); border-color: oklch(0.72 0.22 0 / 0.4); background: oklch(0.72 0.22 0 / 0.06); transform: scale(1.05); }
    .grl-forum-root .grl-btn-like--active { background: oklch(0.72 0.22 0 / 0.15); color: var(--grl-primary); border-color: oklch(0.72 0.22 0 / 0.4); box-shadow: 0 0 20px oklch(0.72 0.22 0 / 0.15); }

    .grl-forum-root .grl-card { border-radius: 1rem; border: 1px solid var(--grl-border); background: var(--grl-card); backdrop-filter: blur(16px); transition: all 0.4s ease; }
    .grl-forum-root .grl-card:hover { border-color: oklch(0.72 0.22 0 / 0.2); }
    .grl-forum-root .grl-card-3xl { border-radius: 1.5rem; }

    .grl-forum-root .grl-thread-row { cursor: pointer; padding: 0.875rem 1rem; transition: all 0.3s ease; border-bottom: 1px solid var(--grl-border-light); position: relative; }
    ...
    .grl-forum-root .grl-thread-row::before { content: ""; position: absolute; left: 0; top: 0; bottom: 0; width: 2px; background: transparent; transition: background 0.4s ease; }
    .grl-forum-root .grl-thread-row:hover::before { background: linear-gradient(to bottom, var(--grl-primary), oklch(0.60 0.26 330)); }

    .grl-forum-root .grl-post-card { border-radius: 1rem; border: 1px solid var(--grl-border); background: var(--grl-card); backdrop-filter: blur(16px); overflow: hidden; transition: all 0.4s ease; box-shadow: 0 4px 24px oklch(0 0 0 / 0.2); animation: grlFadeUp 0.5s cubic-bezier(0.22, 1, 0.36, 1) both; }
    .grl-forum-root .grl-post-card:hover { border-color: oklch(0.72 0.22 0 / 0.25); box-shadow: 0 8px 40px oklch(0 0 0 / 0.3); }

    .grl-forum-root .grl-verdict-banner { display: flex; align-items: center; gap: 0.75rem; padding: 0.75rem 1.25rem; border-radius: 0.75rem; font-size: 0.8rem; font-weight: 700; animation: grlFadeUp 0.4s ease both; }
    ...
    .grl-forum-root .grl-error-box { background: oklch(0.65 0.24 25 / 0.1); border: 1px solid oklch(0.65 0.24 25 / 0.3); color: oklch(0.78 0.20 25); padding: 0.75rem 1rem; border-radius: 0.75rem; font-size: 0.875rem; display: flex; align-items: center; gap: 0.5rem; }
    .grl-forum-root .grl-label { display: flex; align-items: center; gap: 0.5rem; font-size: 0.65rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.12em; color: var(--grl-muted-foreground); margin-bottom: 0.4rem; }
    .grl-forum-root .grl-sidebar-header { padding: 0.875rem 1.125rem; border-bottom: 1px solid var(--grl-border); display: flex; align-items: center; justify-content: space-between; }
    .grl-forum-root .grl-modal-overlay { position: fixed; inset: 0; z-index: 50; display: flex; align-items: center; justify-content: center; padding: 1rem; background: oklch(0.15 0.025 285 / 0.85); backdrop-filter: blur(20px); animation: grlFadeIn 0.4s ease both; }
    .grl-forum-root .grl-truncate { overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }

    .grl-toast { position: fixed; bottom: 2rem; right: 2rem; z-index: 9999; background: oklch(0.20 0.03 285); border: 1px solid oklch(0.72 0.22 0 / 0.3); color: oklch(0.97 0.005 250); padding: 0.875rem 1.25rem; border-radius: 0.875rem; font-size: 0.825rem; font-weight: 700; font-family: "Rajdhani","Noto Sans Georgian",system-ui,sans-serif; box-shadow: 0 8px 32px oklch(0 0 0 / 0.4); display: flex; align-items: center; gap: 0.625rem; animation: grlFadeUp 0.4s ease both; max-width: 320px; }
    .grl-toast--role { border-color: oklch(0.72 0.22 5 / 0.5); }

    @keyframes grlFadeIn { from { opacity: 0; } to { opacity: 1; } }
    @keyframes grlFadeUp { from { opacity: 0; transform: translateY(12px); } to { opacity: 1; transform: translateY(0); } }
    @keyframes grlFadeScale { from { opacity: 0; transform: scale(0.95) translateY(8px); } to { opacity: 1; transform: scale(1) translateY(0); } }
    @keyframes grlPing { 75%, 100% { transform: scale(2); opacity: 0; } }
    @keyframes grlSpin { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }
    @keyframes grlShimmer { 0% { background-position: -200% center; } 100% { background-position: 200% center; } }
    @keyframes grlFloat { 0%, 100% { transform: translateY(0); } 50% { transform: translateY(-6px); } }
    @keyframes grlSkylineGlow { 0%, 100% { opacity: 0.55; } 50% { opacity: 0.85; } }
    @keyframes grlGridScroll { from { transform: translateY(0); } to { transform: translateY(64px); } }
    @keyframes grlScanline { from { transform: translateY(-100%); } to { transform: translateY(100vh); } }
    ...
    .grl-forum-root .grl-thread-header { display: grid; grid-template-columns: 1fr 70px 80px 150px; padding: 0.6rem 1rem; background: oklch(0.18 0.03 285 / 0.5); border-bottom: 1px solid var(--grl-border); font-size: 0.55rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.15em; color: var(--grl-muted-foreground); align-items: center; gap: 1rem; }

    .grl-cv-status-badge { display: inline-flex; align-items: center; gap: 0.2rem; padding: 0.08rem 0.4rem; border-radius: 999px; font-size: 0.45rem; font-weight: 800; letter-spacing: 0.08em; text-transform: uppercase; }
    ...
    @media (max-width: 767px) {
      ...
      .grl-forum-root .grl-stat-col, .grl-forum-root .grl-last-post-col, .grl-forum-root .grl-thread-header { display: none; }
      .grl-forum-root .grl-post-card > div { grid-template-columns: 1fr !important; }
      .grl-forum-root .grl-post-card > div > div:first-child { border-right: none !important; border-bottom: 1px solid var(--grl-border); flex-direction: row !important; flex-wrap: wrap; justify-content: center; padding: 0.75rem !important; gap: 0.5rem !important; }
    }
    ...
    .grl-bg-scene { position: fixed; inset: 0; pointer-events: none; z-index: 0; overflow: hidden; }
    .grl-bg-grid { position: absolute; bottom: 0; left: 0; right: 0; height: 55%; background-image: linear-gradient(to right, oklch(0.72 0.22 0 / 0.07) 1px, transparent 1px), linear-gradient(to bottom, oklch(0.72 0.22 0 / 0.07) 1px, transparent 1px); background-size: 64px 64px; transform-origin: bottom center; transform: perspective(600px) rotateX(55deg) scaleX(2.2); mask-image: linear-gradient(to top, black 0%, black 40%, transparent 100%); -webkit-mask-image: linear-gradient(to top, black 0%, black 40%, transparent 100%); animation: grlGridScroll 4s linear infinite; }
    .grl-bg-scanline { position: absolute; left: 0; right: 0; height: 3px; background: linear-gradient(to bottom, transparent, oklch(0.72 0.22 0 / 0.12), transparent); animation: grlScanline 8s linear infinite; pointer-events: none; }
    .grl-bg-horizon { position: absolute; bottom: 38%; left: 0; right: 0; height: 2px; background: linear-gradient(to right, transparent 0%, oklch(0.72 0.22 0 / 0.6) 20%, oklch(0.82 0.18 340 / 0.9) 50%, oklch(0.72 0.22 0 / 0.6) 80%, transparent 100%); filter: blur(1px); box-shadow: 0 0 30px 4px oklch(0.72 0.22 0 / 0.3); }
    .grl-bg-atmosphere { position: absolute; top: 0; left: 0; right: 0; height: 100%; background: radial-gradient(ellipse 80% 45% at 50% -5%, oklch(0.45 0.20 350 / 0.30), transparent 60%), radial-gradient(ellipse 60% 40% at 15% 30%, oklch(0.40 0.22 285 / 0.18), transparent 55%), radial-gradient(ellipse 50% 35% at 85% 25%, oklch(0.38 0.20 320 / 0.15), transparent 50%); }
  `;
...
function CityBackground() {
  return (
    <div className="grl-bg-scene">
      ...
      <svg style={{ position:"absolute", bottom:"36%", left:0, width:"100%", height:"auto", minHeight:260, opacity:0.65, animation:"grlSkylineGlow 6s ease-in-out infinite" }}
        viewBox="0 0 1440 280" preserveAspectRatio="xMidYMax slice" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="skyBg" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="oklch(0.72 0.22 0)" stopOpacity="0.3"/><stop offset="100%" stopColor="oklch(0.12 0.02 285)" stopOpacity="1"/></linearGradient>
          <linearGradient id="buildingDark" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#0a0a1a" stopOpacity="0.95"/><stop offset="100%" stopColor="#050510" stopOpacity="1"/></linearGradient>
...
const iconMap = { Shield, Wrench, Sparkles, Unlock, Calendar, BookOpen, Award, ClipboardList, Video, Landmark, Scale, Eye, FileText, AlertCircle, UserX, CheckSquare, MessageCircle, Briefcase };
...
/* ─── localStorage helpers (users only — threads now in Supabase) ─────────── */
const loadUsers       = () => { try { return JSON.parse(localStorage.getItem("grl_users") || "[]"); } catch { return []; } };
const loadCurrentUser = () => { try { return JSON.parse(localStorage.getItem("grl_current_user") || "null"); } catch { return null; } };
...
const syncCurrentUser = () => {
  try {
    ...
    if (!found) { localStorage.removeItem("grl_current_user"); return null; }
...
function statusKind(label = "") {
  ...
  if (s.includes("ინფო"))     return "info";
...
function VerdictBanner({ verdict, reason, closedBy, closedAt }) {
  ...
  if (isHired) {
    return (
      <div className="grl-verdict-banner grl-verdict-banner--hired">
        ...
        <div>
          <div style={{ fontFamily:"var(--grl-font-display)", letterSpacing:"0.05em", fontSize:"0.875rem" }}>✅ კანდიდატი აყვანილია — ვაკანსია დახურულია!</div>
          {closedBy && <div style={{ fontSize:"0.75rem", fontWeight:400, marginTop:"0.25rem", opacity:0.85 }}>ადმინი: {closedBy} · {closedAt ? new Date(closedAt).toLocaleString("ka-GE") : ""}</div>}
        </div>
      </div>
    );
  }
  return (
    <div className={`grl-verdict-banner grl-verdict-banner--${isApproved ? "approved" : "rejected"}`}>
      ...
      <div>
        <div style={{ fontFamily:"var(--grl-font-display)", letterSpacing:"0.05em", fontSize:"0.875rem" }}>{isApproved ? "საჩივარი დადასტურებულია" : "საჩივარი უარყოფილია"}</div>
        {reason && <div style={{ fontSize:"0.75rem", fontWeight:400, marginTop:"0.25rem", opacity:0.85 }}>მიზეზი: {reason}</div>}
      </div>
    </div>
  );
}
...
function Toast({ message, icon, onDone }) {
  ...
  return <div className="grl-toast grl-toast--role">{icon}<span>{message}</span></div>;
}
...
function RegisterForm({ onRegister, onLoginClick }) {
  ...
  const handleSubmit = async () => {
    ...
    const newUser = {
      ...
      role: isChavle(username) ? "tec" : "player",
      avatarBg: isChavle(username) ? "linear-gradient(135deg,#ff2d78,#8b00ff)" : `linear-gradient(135deg,${c1},${c2})`,
      isAdmin: isChavle(username),
    };

    // Save to Supabase
    try {
      await supabase.from("grl_users").upsert({
        id: newUser.id, username: newUser.username, email: newUser.email,
        password: newUser.password, role: newUser.role,
        avatar_bg: newUser.avatarBg, is_admin: newUser.isAdmin,
      });
    } catch {}
    ...
    <div>
      ...
      <div style={{ display:"flex", flexDirection:"column", gap:"1.25rem" }}>
        <div>
          ...
          {isChavle(username) && <div style={{ fontSize:"0.65rem", color:"oklch(0.72 0.23 25)", marginTop:"0.25rem", fontWeight:700 }}>👑 ეს არის ადმინისტრატორის ანგარიში</div>}
        </div>
        <div>
  ...
  return (
    <div>
      ...
      <div style={{ display:"flex", flexDirection:"column", gap:"1.25rem" }}>
        ...
        <div style={{ paddingTop:"1rem", borderTop:"1px solid var(--grl-border)", display:"flex", flexDirection:"column", gap:"0.75rem" }}>
          <button type="button" onClick={handleSubmit} className="grl-btn grl-btn-primary" style={{ width:"100%", padding:"0.875rem 1.5rem" }}><LogIn size={18}/> შესვლა</button>
          <p style={{ textAlign:"center", fontSize:"0.75rem", color:"var(--grl-muted-foreground)" }}>
            არ გაქვთ ანგარიში?{" "}
...
function useForumHistory() {
  ...
  const goBack = useCallback(() => { if (historyIndex > 0) setHistoryIndex(prev => prev - 1); }, [historyIndex]);
    ...
    <div className={`grl-subforum-row${isVacancy?" grl-subforum-row--vacancy":""}`} onClick={onClick}>
      ...
      <div>
        <div className="grl-subforum-name">
          ...
          {isVacancy && <span style={{ fontSize:"0.55rem", padding:"0.1rem 0.5rem", borderRadius:"999px", background:"linear-gradient(135deg, oklch(0.72 0.22 0/0.15), oklch(0.78 0.14 220/0.12))", color:"oklch(0.85 0.14 0)", border:"1px solid oklch(0.72 0.22 0/0.3)", fontWeight:700, letterSpacing:"0.08em" }}>CHIEF+ / ADMIN</span>}
        </div>
        {isVacancy && <div className="grl-subforum-sub">ვაკანსიების შექმნა: Chief / D.Chief / Admin · CV-ის გაგზავნა: ყველა</div>}
      </div>
      <div style={{ display:"flex", gap:"2rem" }}>
        <div className="grl-stat-col"><div className="grl-stat-num">{sub.topicsCount >= 1000 ? `${(sub.topicsCount/1000).toFixed(1)}K` : sub.topicsCount}</div><div className="grl-stat-label">ვაკ.</div></div>
        <div className="grl-stat-col"><div className="grl-stat-num">{sub.postsCount >= 1000 ? `${(sub.postsCount/1000).toFixed(1)}K` : sub.postsCount}</div><div className="grl-stat-label">CV</div></div>
      </div>
      <div className="grl-last-post-col">
        {sub.lastPost ? (
          <><div className="grl-last-post-avatar" style={{ background: sub.lastPost.avatarBg || "linear-gradient(135deg,#ec4899,#f43f5e)" }}>{sub.lastPost.author[0].toUpperCase()}</div>
          <div><StatusLabel label={sub.lastPost.label || "ვაკანსია"}/><span className="grl-last-post-title" style={{ marginTop:"0.2rem" }}>{sub.lastPost.threadTitle}</span><span className="grl-last-post-meta">{sub.lastPost.date} · {sub.lastPost.author}</span></div></>
...
function DefaultSubforumRow({ sub, onClick }) {
  ...
  return (
    <div className="grl-subforum-row" onClick={onClick}>
      <div className="grl-subforum-icon-wrap"><SubIcon size={18}/></div>
      <div><div className="grl-subforum-name">{sub.title}{sub.topicsCount > 0 && <span className="grl-new-badge">NEW</span>}</div></div>
      <div style={{ display:"flex", gap:"2rem" }}>
        <div className="grl-stat-col"><div className="grl-stat-num">{sub.topicsCount >= 1000 ? `${(sub.topicsCount/1000).toFixed(1)}K` : sub.topicsCount}</div><div className="grl-stat-label">Threads</div></div>
        <div className="grl-stat-col"><div className="grl-stat-num">{sub.postsCount >= 1000 ? `${(sub.postsCount/1000).toFixed(1)}K` : sub.postsCount}</div><div className="grl-stat-label">Messages</div></div>
      </div>
      <div className="grl-last-post-col">
        {sub.lastPost ? (
          <><div className="grl-last-post-avatar" style={{ background: sub.lastPost.avatarBg || "linear-gradient(135deg,#ec4899,#f43f5e)" }}>{sub.lastPost.author[0].toUpperCase()}</div>
          <div><StatusLabel label={sub.lastPost.label || "ინფო"}/><span className="grl-last-post-title" style={{ marginTop:"0.2rem" }}>{sub.lastPost.threadTitle}</span><span className="grl-last-post-meta">{sub.lastPost.date} · {sub.lastPost.author}</span></div></>
    ...
    <div className={`grl-category-block${isVacancyCat?" grl-category-block--vacancy":""}`}>
      <div className="grl-category-header" onClick={()=>setCollapsed(c=>!c)}>
        <span className="grl-category-title">
          ...
          {category.title}
          {isVacancyCat && <span style={{ fontSize:"0.55rem", padding:"0.15rem 0.6rem", borderRadius:"999px", background:"linear-gradient(135deg, oklch(0.72 0.22 0/0.15), oklch(0.78 0.14 220/0.12))", color:"oklch(0.85 0.14 0)", border:"1px solid oklch(0.72 0.22 0/0.3)", fontWeight:700, letterSpacing:"0.1em" }}>✦ HIRING</span>}
        </span>
        <span style={{ color:"var(--grl-muted-foreground)", display:"flex", alignItems:"center" }}>{collapsed ? <ChevronDown size={18}/> : <ChevronUp size={18}/>}</span>
      </div>
      {!collapsed && <div>{subforums.map(sub => isVacancyCat ? <SubforumRow key={sub.id} sub={sub} onClick={()=>onSubforumClick(sub.id)}/> : <DefaultSubforumRow key={sub.id} sub={sub} onClick={()=>onSubforumClick(sub.id)}/>)}</div>}
    </div>
  );
}
...
function CVForm({ onSubmit, onCancel, vacancyTitle }) {
  const [fields, setFields] = useState(CV_FIELDS.reduce((acc,f) => ({ ...acc, [f.key]:"" }), {}));
  const [error, setError] = useState("");

  const handleSubmit = () => {
    const empty = CV_FIELDS.find(f => !fields[f.key].trim());
    if (empty) { setError(`გთხოვთ შეავსოთ: ${empty.label}`); return; }
    onSubmit({ __type:"cv", vacancyTitle, ...fields });
  };
  ...
  return (
    <div className="grl-cv-form">
      <div style={{ display:"flex", alignItems:"center", gap:"0.625rem", marginBottom:"1.25rem" }}>
        ...
        <h3 style={{ fontSize:"0.875rem", fontWeight:800, textTransform:"uppercase", letterSpacing:"0.15em", color:"oklch(0.80 0.18 155)", margin:0 }}>CV — {vacancyTitle}</h3>
      </div>
      {error && <div className="grl-error-box" style={{ marginBottom:"1rem" }}><AlertCircle size={14}/><span style={{ fontSize:"0.8rem" }}>{error}</span></div>}
      {CV_FIELDS.map(f => (
        <div key={f.key} className="grl-cv-field">
          <label className="grl-label" style={{ color:"oklch(0.70 0.18 155)" }}>{f.label}</label>
          <input type="text" value={fields[f.key]} onChange={e=>setFields(prev=>({ ...prev, [f.key]:e.target.value }))} placeholder={f.placeholder} className="grl-input" style={{ fontSize:"0.8rem" }}/>
        </div>
      ))}
      <div style={{ display:"flex", gap:"0.75rem", justifyContent:"flex-end", marginTop:"1rem" }}>
        <button onClick={onCancel} className="grl-btn grl-btn-ghost grl-btn-sm">გაუქმება</button>
        <button onClick={handleSubmit} className="grl-btn grl-btn-cv grl-btn-sm"><Send size={14}/> CV გაგზავნა</button>
      </div>
    </div>
  );
}
...
function CVSuccessModal({ onClose }) {
  return (
    <div className="grl-modal-overlay" onClick={e=>e.target===e.currentTarget&&onClose()}>
      <div className="grl-card grl-card-3xl grl-animate-fadescale" style={{ maxWidth:420, padding:"2.5rem 2rem", textAlign:"center", border:"2px solid oklch(0.72 0.19 160/0.4)", boxShadow:"0 0 60px oklch(0.72 0.19 160/0.15)" }}>
        <div style={{ width:80, height:80, borderRadius:"50%", background:"linear-gradient(135deg, oklch(0.55 0.22 155), oklch(0.45 0.20 175))", display:"flex", alignItems:"center", justifyContent:"center", margin:"0 auto 1.5rem", boxShadow:"0 0 40px oklch(0.55 0.22 155/0.3)" }}>
          <CheckCircle2 size={40} style={{ color:"#fff" }}/>
        </div>
        <h3 style={{ fontFamily:"var(--grl-font-display)", fontSize:"1.5rem", color:"oklch(0.97 0.005 250)", marginBottom:"0.5rem" }}>CV წარმატებით გაიგზავნა! 🎉</h3>
        <p style={{ fontSize:"0.9rem", color:"oklch(0.75 0.18 155)", marginBottom:"1rem", fontWeight:600 }}>თქვენი CV მიღებულია ადმინისტრაციის მიერ.</p>
        <div style={{ padding:"1rem", borderRadius:"0.75rem", background:"oklch(0.55 0.20 155/0.08)", border:"1px solid oklch(0.55 0.20 155/0.2)", marginBottom:"1.5rem" }}>
        ...
        <button onClick={onClose} className="grl-btn grl-btn-primary" style={{ width:"100%" }}><CheckCircle2 size={16}/> კარგი, მივხვდი</button>
      </div>
    </div>
  );
}
...
export default function ForumPage() {
  ...
  useEffect(() => {
    ...
    const t1 = setInterval(() => {
      setTitleAnimated(titleText.slice(0, i)); i++;
      if (i > titleText.length) {
        clearInterval(t1); let j = 0;
        const t2 = setInterval(() => { setSubtitleAnimated(subtitleText.slice(0, j)); j++; if (j > subtitleText.length) clearInterval(t2); }, 150);
      }
    }, 100);
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const [{ data: tData }, { data: cData }] = await Promise.all([
        supabase.from("grl_threads").select("*").order("created_at", { ascending: false }),
        supabase.from("grl_cvs").select("*").order("submitted_at", { ascending: false }),
      ]);
      if (tData) setThreads(tData.map(dbToThread));
      if (cData) setCvs(cData.map(dbToCv));
      setLoading(false);
    };
    fetchData();
  }, []);
  ...
  useEffect(() => {
    const threadSub = supabase
      .channel("grl_threads_changes")
      .on("postgres_changes", { event: "*", schema: "public", table: "grl_threads" }, (payload) => {
        if (payload.eventType === "INSERT") {
          setThreads(prev => [dbToThread(payload.new), ...prev]);
        } else if (payload.eventType === "UPDATE") {
          setThreads(prev => prev.map(t => t.id === payload.new.id ? dbToThread(payload.new) : t));
    ...
    const cvSub = supabase
      .channel("grl_cvs_changes")
      .on("postgres_changes", { event: "*", schema: "public", table: "grl_cvs" }, (payload) => {
        if (payload.eventType === "INSERT") {
          setCvs(prev => [dbToCv(payload.new), ...prev]);
        } else if (payload.eventType === "UPDATE") {
          setCvs(prev => prev.map(c => c.id === payload.new.id ? dbToCv(payload.new) : c));
        } else if (payload.eventType === "DELETE") {
  ...
  function dbToThread(row) {
    return {
      id:            row.id,
      title:         row.title,
      subforumId:    row.subforum_id,
      author:        row.author,
      avatarBg:      row.avatar_bg,
      label:         row.label,
      date:          row.date || new Date(row.created_at).toLocaleDateString("ka-GE"),
      repliesCount:  row.replies_count || 0,
      viewsCount:    row.views_count || 0,
      isPinned:      row.is_pinned,
      isComplaint:   row.is_complaint,
      isVacancy:     row.is_vacancy,
  ...
  function dbToCv(row) {
    return {
      ...
      authorRoleColor: row.author_role_color,
      ...
      vacancyClosed:   row.vacancy_closed,
    };
  }
  ...
  useEffect(() => {
    setSubforums(prev => prev.map(s => {
      ...
      const last = subs.length > 0 ? [...subs].sort((a,b) => new Date(b.date).getTime() - new Date(a.date).getTime())[0] : null;
      return {
        ...s,
  ...
  /* ─── Persist likes ── */
  useEffect(() => { try { localStorage.setItem("grl_liked_posts", JSON.stringify(likedPosts)); } catch {} }, [likedPosts]);
  ...
  const latestActivity  = useMemo(() => [...threads].filter(t => t.posts?.length > 0).sort((a,b) => new Date(b.date) - new Date(a.date)).slice(0,5), [threads]);
  const onlineMembers   = useMemo(() => currentUser ? [currentUser.username] : [], [currentUser]);

  const canCreateThread = (subforumId) => {
    if (!currentUser) return false;
    if (VACANCY_SUBFORUMS.includes(subforumId)) return userIsChief || isAdmin;
  ...
  const navThread   = async (sub, id) => {
    push({ view:"thread", subforumId:sub||currentSubforumId, threadId:id });
    setShowCVForm(false);
    // increment views in DB
    const t = threads.find(x => x.id === id);
    if (t) {
      await supabase.from("grl_threads").update({ views_count: (t.viewsCount||0)+1 }).eq("id", id);
    }
  };
  ...
  const handleLikePost = async (postId) => {
    ...
    // update posts array in Supabase
    const thread = threads.find(t => t.id === currentThreadId);
    if (!thread) return;
    const newPosts = thread.posts.map(p => p.id!==postId ? p : { ...p, likes: liked ? Math.max(0,p.likes-1) : p.likes+1 });
    await supabase.from("grl_threads").update({ posts: newPosts }).eq("id", currentThreadId);
  };

  const handleDeletePost = async (postId) => {
    const thread = threads.find(t => t.id === currentThreadId);
    if (!thread) return;
    const isFirst = thread.posts[0]?.id === postId;
    if (isFirst) {
      // delete whole thread
      await supabase.from("grl_threads").delete().eq("id", currentThreadId);
      goBack();
    } else {
      const newPosts = thread.posts.filter(p => p.id !== postId);
      await supabase.from("grl_threads").update({ posts: newPosts, replies_count: Math.max(0, (thread.repliesCount||0)-1) }).eq("id", currentThreadId);
    }
  };

  const handleDeleteThread = async (threadId) => {
    await supabase.from("grl_threads").delete().eq("id", threadId);
  ...
  const handleAddReply = async () => {
    ...
    const newPosts = [...thread.posts, newPost];
    await supabase.from("grl_threads").update({ posts: newPosts, replies_count: (thread.repliesCount||0)+1 }).eq("id", currentThreadId);
    setReplyText("");
  };

  const handleSubmitCV = async (fields) => {
    ...
    const cvData = {
      ...
      vacancy_title:     thread?.title || "ვაკანსია",
      author:            currentUser.username,
      author_avatar:     currentUser.avatarBg || "linear-gradient(135deg,#ec4899,#f43f5e)",
      author_role:       getRoleLabel(currentUser),
      author_role_color: getRoleColor(currentUser),
    ...
    await supabase.from("grl_cvs").insert(cvData);
    setShowCVForm(false);
  ...
  const handleCreateThread = async () => {
    ...
    const row = {
      ...
      subforum_id:   currentSubforumId,
      author:        currentUser.username,
      avatar_bg:     currentUser.avatarBg || "linear-gradient(135deg,#ec4899,#f43f5e)",
      ...
      allow_replies: !isComplaint,
      is_closed:     false,
      is_admin_post: isAdmin,
      posts:         [firstPost],
    };

    await supabase.from("grl_threads").insert(row);
  ...
  if (showAuth) return (
    <AuthShell>
      <button onClick={()=>setShowAuth(false)} style={{ position:"absolute", top:"1rem", right:"1rem", color:"var(--grl-muted-foreground)", background:"none", border:"none", cursor:"pointer" }}><XCircle size={24}/></button>
      {authMode==="login"
  ...
  return (
    <div className="grl-forum-root">
      ...
      {showCVSuccess && <CVSuccessModal onClose={()=>setShowCVSuccess(false)}/>}
        ...
        <div style={{ maxWidth:"72rem", margin:"0 auto", position:"relative", zIndex:1 }}>
            ...
            <div style={{ display:"flex", alignItems:"center", gap:"0.375rem", fontSize:"0.75rem", color:"var(--grl-muted-foreground)", fontWeight:600, flexWrap:"wrap" }}>
              {viewState!=="home" && (<>
                ...
                <button onClick={()=>push({ view:"subforum", subforumId:currentSubforumId, threadId:"" })}
                  style={{ background:"none", border:"none", cursor:"pointer", color:viewState==="subforum"?"var(--grl-primary)":"var(--grl-muted-foreground)", fontWeight:600, fontSize:"0.75rem", padding:0 }}>
                  {currentSubforum?.title}
                </button>
              </>)}
              {viewState==="thread" && (<><ChevronRight size={12} style={{ opacity:0.5 }}/><span style={{ color:"var(--grl-primary)" }}>{currentThread?.title}</span></>)}
            </div>
          </div>
              ...
              <div style={{ position:"relative", display:"flex", flexWrap:"wrap", alignItems:"center", justifyContent:"space-between", gap:"2rem", zIndex:1 }}>
                <div style={{ flex:1, minWidth:"280px" }}>
                  <div style={{ display:"flex", alignItems:"center", gap:"0.6rem", color:"oklch(0.82 0.15 0)", fontSize:"0.65rem", letterSpacing:"0.35em", fontWeight:700, textTransform:"uppercase", marginBottom:"1rem", fontFamily:"var(--grl-font-mono)" }}>
                    <div style={{ width:8, height:8, borderRadius:"50%", background:"oklch(0.74 0.22 0)", boxShadow:"0 0 12px oklch(0.74 0.22 0)", animation:"grlPulse 2s ease-in-out infinite" }}/>
                  ...
                  <div style={{ display:"flex", alignItems:"center", gap:"1.5rem", flexWrap:"wrap" }}>
                    {[{ num:forumStats.members, label:"წევრი", accent:true }, { num:forumStats.posts, label:"პოსტი" }, { num:forumStats.complaints, label:"საჩივარი" }].map((s,i) => (
                      <div key={i} style={{ display:"flex", flexDirection:"column", gap:"0.1rem" }}>
                        <span style={{ fontFamily:"var(--grl-font-mono)", fontSize:"clamp(1.1rem,1.5vw,1.4rem)", fontWeight:700, color:s.accent?"oklch(0.82 0.15 0)":"oklch(0.95 0.005 250)" }}>{s.num >= 1000 ? `${(s.num/1000).toFixed(1)}K` : s.num}</span>
                ...
                <div style={{ display:"flex", flexDirection:"column", gap:"0.75rem", alignItems:"flex-end", flexShrink:0, minWidth:"200px" }}>
                  <a href="https://discord.gg/un2cx4jHH" target="_blank" rel="noreferrer" className="grl-btn grl-btn-outline-primary" style={{ fontSize:"0.75rem", padding:"0.7rem 1.5rem", gap:"0.6rem", width:"100%", justifyContent:"center", borderRadius:"0.75rem", border:"1px solid oklch(0.72 0.22 0/0.3)", background:"oklch(0.72 0.22 0/0.05)" }}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style={{ color:"oklch(0.72 0.22 0)" }}><path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057.102 18.079.114 18.1.13 18.11a19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028 14.09 14.09 0 0 0 1.226-1.994.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.892.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03z"/></svg>
          ...
          <div className="grl-lg-grid-main">
            <div style={{ minWidth:0 }}>
              ...
              {/* ── Loading ── */}
              {loading && (
                <div style={{ textAlign:"center", padding:"4rem", color:"var(--grl-muted-foreground)" }}>
                  <Loader2 size={32} style={{ animation:"grlSpin 1s linear infinite", margin:"0 auto 1rem", display:"block", color:"var(--grl-primary)" }}/>
                  <p>ფორუმი იტვირთება...</p>
                </div>
              )}
              ...
              {!loading && viewState==="home" && (
                <div className="grl-animate-fadein">
                  {initialCategories.map(cat => {
                    ...
                    return <CategoryBlock key={cat.id} category={cat} subforums={subs} onSubforumClick={navSubforum}/>;
                  })}
                </div>
              )}

              {/* ── SUBFORUM ── */}
              {!loading && viewState==="subforum" && currentSubforum && (
                <div className="grl-animate-fadein" style={{ display:"flex", flexDirection:"column", gap:"1.25rem" }}>
                  <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:"0.75rem" }}>
                    <button onClick={goBack} style={{ display:"inline-flex", alignItems:"center", gap:"0.5rem", fontSize:"0.75rem", fontWeight:700, color:"var(--grl-muted-foreground)", background:"none", border:"none", cursor:"pointer", padding:0 }} onMouseEnter={e=>e.currentTarget.style.color="var(--grl-primary)"} onMouseLeave={e=>e.currentTarget.style.color="var(--grl-muted-foreground)"}>
                      <ArrowLeft size={14}/> განყოფილებებში დაბრუნება
                    </button>
                    {canCreateThread(currentSubforumId) ? (
                      <button onClick={()=>{ if (!currentUser) { setShowAuth(true); return; } setIsModalOpen(true); }} className="grl-btn grl-btn-sm grl-btn-primary">
                        <Plus size={14}/>{isVacancySubforum(currentSubforumId) ? "ვაკანსიის გამოქვეყნება" : "ახალი თემა"}
                      </button>
                    ) : isVacancySubforum(currentSubforumId) ? (
                      <span style={{ fontSize:"0.6rem", padding:"0.25rem 0.75rem", borderRadius:"0.5rem", background:"oklch(0.72 0.22 0/0.1)", color:"var(--grl-primary)", fontWeight:600, border:"1px solid oklch(0.72 0.22 0/0.25)" }}>🔒 Chief / D.Chief / Admin only</span>
                    ) : (
                      <span style={{ fontSize:"0.6rem", padding:"0.25rem 0.75rem", borderRadius:"0.5rem", background:"oklch(0.68 0.24 0/0.1)", color:"var(--grl-primary)", fontWeight:600, border:"1px solid oklch(0.68 0.24 0/0.25)" }}>🔒 მხოლოდ ადმინისტრაცია</span>
                    )}
                  </div>
                    ...
                    {threads.filter(t => t.subforumId === currentSubforumId).length === 0 ? (
                      <div style={{ padding:"2rem", textAlign:"center", color:"var(--grl-muted-foreground)" }}>
                        ...
                        {isVacancySubforum(currentSubforumId) && (userIsChief || isAdmin) && (
                          <button onClick={()=>setIsModalOpen(true)} className="grl-btn grl-btn-primary grl-btn-sm" style={{ marginTop:"1rem" }}>
                      ...
                      threads.filter(t => t.subforumId === currentSubforumId).map(t => {
                        const threadCvs = cvs.filter(c => c.threadId === t.id);
                        const cvCount   = threadCvs.length;
                        const hiredCV   = threadCvs.find(c => c.hired);
                        ...
                        return (
                          <div key={t.id} className="grl-thread-row" style={{ display:"flex", alignItems:"center", justifyContent:"space-between" }}>
                              ...
                              <div style={{ display:"flex", alignItems:"center", gap:"0.5rem", flexWrap:"wrap" }}>
                                ...
                                {isVacancySubforum(currentSubforumId) && cvCount > 0 && (
                                  <span className={`grl-cv-badge${isHired?" grl-cv-badge--hired":""}`}>
                                    {isHired ? <><CheckCircle2 size={9}/> {cvCount} CV · აყვანილია</> : <><Briefcase size={9}/> {cvCount} CV</>}
                                  </span>
                                )}
                                {t.isClosed && !isHired && <span className="grl-status-label grl-status-label--closed"><Lock size={9}/> დახურულია</span>}
                                {isHired && <span className="grl-status-label grl-status-label--hired"><CheckCircle2 size={9}/> აყვანილია</span>}
                              </div>
                            ...
                            <div style={{ display:"flex", alignItems:"center", gap:"0.75rem" }}>
                              ...
                              {isAdmin && (
                                <button onClick={()=>handleDeleteThread(t.id)} className="grl-btn-danger" style={{ padding:"0.2rem 0.5rem" }}><Trash2 size={12}/> წაშლა</button>
                              )}
                            </div>
                          </div>
                        );
              ...
              {/* ── THREAD ── */}
              {!loading && viewState==="thread" && currentThread && (
                <div className="grl-animate-fadein" style={{ display:"flex", flexDirection:"column", gap:"1.25rem" }}>
                  <button onClick={goBack} style={{ display:"inline-flex", alignItems:"center", gap:"0.5rem", fontSize:"0.75rem", fontWeight:700, color:"var(--grl-muted-foreground)", background:"none", border:"none", cursor:"pointer", padding:0 }} onMouseEnter={e=>e.currentTarget.style.color="var(--grl-primary)"} onMouseLeave={e=>e.currentTarget.style.color="var(--grl-muted-foreground)"}>
                  ...
                  <div className="grl-card" style={{ padding:"1.5rem", display:"flex", flexWrap:"wrap", alignItems:"center", justifyContent:"space-between", gap:"1rem", position:"relative", overflow:"hidden" }}>
                    ...
                    <div style={{ minWidth:0, position:"relative" }}>
                      <div style={{ display:"flex", alignItems:"center", gap:"0.5rem", marginBottom:"0.625rem" }}>
                        ...
                        {currentThread.isClosed && <span className="grl-status-label grl-status-label--closed"><Lock size={11}/> დახურულია</span>}
                      </div>
                      ...
                      {currentThread.isVacancy && (
                        <div style={{ marginTop:"0.5rem", fontSize:"0.7rem", color:"oklch(0.85 0.16 0)", fontWeight:600, display:"flex", alignItems:"center", gap:"0.4rem" }}>
                          ...
                          {(() => { const hired = cvs.find(c => c.threadId === currentThread.id && c.hired); if (hired) return <span style={{ color:"oklch(0.78 0.19 160)", display:"flex", alignItems:"center", gap:"0.3rem" }}><CheckCircle2 size={12}/> აყვანილია: {hired.author}</span>; return null; })()}
                        </div>
                      )}
                    </div>
                  ...
                  {currentThread.isComplaint && currentThread.verdict && <VerdictBanner verdict={currentThread.verdict} reason={currentThread.verdictReason}/>}

                  {(() => {
                    const hiredCV = cvs.find(c => c.threadId === currentThread.id && c.hired);
                    if (hiredCV) return <VerdictBanner verdict="hired" closedBy={hiredCV.hiredBy} closedAt={hiredCV.hiredAt}/>;
                    if (currentThread.isClosed) return (
                      <div className="grl-verdict-banner grl-verdict-banner--approved" style={{ background:"oklch(0.50 0.10 250/0.1)", border:"1px solid oklch(0.50 0.10 250/0.3)", color:"oklch(0.70 0.10 250)" }}>
                        <Lock size={20}/><div><div style={{ fontFamily:"var(--grl-font-display)", fontSize:"0.875rem" }}>🔒 ვაკანსია დახურულია</div><div style={{ fontSize:"0.75rem", fontWeight:400, marginTop:"0.25rem", opacity:0.85 }}>CV-ები აღარ მიიღება</div></div>
                      </div>
                    );
                    return null;
                  })()}
                      ...
                      <article key={post.id} className="grl-post-card">
                        <div style={{ display:"grid", gridTemplateColumns:"180px 1fr" }}>
                          <div style={{ padding:"1.25rem", display:"flex", flexDirection:"column", alignItems:"center", textAlign:"center", gap:"0.875rem", background:"oklch(0.20 0.03 285/0.3)", borderRight:"1px solid var(--grl-border)" }}>
                            <div style={{ position:"relative" }}>
                              <div style={{ width:58, height:58, borderRadius:"0.875rem", background:post.avatarBg, display:"flex", alignItems:"center", justifyContent:"center", color:"white", fontSize:"1.375rem", fontWeight:700 }}>{post.author[0].toUpperCase()}</div>
                            ...
                            <div>
                              ...
                              <span style={{ display:"inline-block", fontSize:"0.52rem", textTransform:"uppercase", fontWeight:700, letterSpacing:"0.2em", padding:"0.2rem 0.6rem", borderRadius:"999px", marginTop:"0.4rem", border:`1px solid ${(post.roleColor||"#ec4899")}55`, color:post.roleColor||"#ec4899", backgroundColor:`${(post.roleColor||"#ec4899")}15` }}>{post.role}</span>
                              {post.isAdminPost && <div style={{ marginTop:"0.4rem", fontSize:"0.55rem", fontWeight:700, textTransform:"uppercase", letterSpacing:"0.1em", color:"oklch(0.72 0.23 25)" }}>⚙ Admin</div>}
                            </div>
                          </div>
                          <div style={{ padding:"1.25rem", display:"flex", flexDirection:"column", justifyContent:"space-between", gap:"1.25rem", minWidth:0 }}>
                            {post.isAdminPost && (
                              <div style={{ display:"flex", alignItems:"center", gap:"0.5rem", padding:"0.3rem 0.75rem", borderRadius:"0.5rem", background:"oklch(0.65 0.24 25/0.1)", border:"1px solid oklch(0.65 0.24 25/0.3)", marginBottom:"-0.25rem", alignSelf:"flex-start" }}>
                                <Shield size={11} style={{ color:"oklch(0.72 0.23 25)" }}/><span style={{ fontSize:"0.575rem", fontWeight:700, textTransform:"uppercase", letterSpacing:"0.1em", color:"oklch(0.72 0.23 25)" }}>ადმინისტრაციის პოსტი</span>
                              </div>
                            )}
                            {currentThread.isVacancy && isOriginalPost && (
                              <div style={{ padding:"0.625rem 0.875rem", borderRadius:"0.625rem", background:"linear-gradient(135deg, oklch(0.72 0.22 0/0.08), oklch(0.78 0.14 220/0.05))", border:"1px solid oklch(0.72 0.22 0/0.25)", marginBottom:"-0.25rem" }}>
                                <div style={{ fontSize:"0.575rem", fontWeight:800, textTransform:"uppercase", letterSpacing:"0.12em", color:"oklch(0.85 0.16 0)", marginBottom:"0.25rem", display:"flex", alignItems:"center", gap:"0.375rem" }}><Briefcase size={11}/> ვაკანსიის აღწერა</div>
                              </div>
                            )}
                            <div style={{ color:"oklch(0.97 0.005 250/0.9)", fontSize:"0.875rem", lineHeight:1.7, whiteSpace:"pre-wrap", wordBreak:"break-word" }}>{post.content}</div>
                            <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", borderTop:"1px solid var(--grl-border)", paddingTop:"0.875rem", fontSize:"0.7rem", color:"var(--grl-muted-foreground)", flexWrap:"wrap", gap:"0.5rem" }}>
                              ...
                              <div style={{ display:"flex", alignItems:"center", gap:"0.5rem" }}>
                                ...
                                <button onClick={()=>handleLikePost(post.id)} className={`grl-btn-like${likedPosts.includes(post.id)?" grl-btn-like--active":""}`}>
                                  <ThumbsUp size={12} style={{ fill:likedPosts.includes(post.id)?"currentColor":"none" }}/><span>{post.likes}</span>
                                </button>
                              </div>
                            </div>
                          </div>
                  ...
                  {currentThread.isVacancy && currentThread.allowReplies && !currentThread.isClosed && (
                    <div>
                      {showCVForm ? (
                        <CVForm vacancyTitle={currentThread.title} onSubmit={handleSubmitCV} onCancel={()=>setShowCVForm(false)}/>
                      ) : (
                        <div style={{ display:"flex", gap:"0.75rem", flexWrap:"wrap" }}>
                          <button onClick={()=>{ if (!currentUser) { setShowAuth(true); return; } setShowCVForm(true); }} className="grl-btn grl-btn-cv grl-btn-sm"><Briefcase size={14}/> CV გაგზავნა</button>
                          {isAdmin && (
                  ...
                  {currentThread.isVacancy && currentThread.isClosed && (
                    <div className="grl-verdict-banner grl-verdict-banner--approved" style={{ background: cvs.some(c=>c.threadId===currentThread.id&&c.hired) ? "oklch(0.72 0.19 160/0.12)" : "oklch(0.50 0.10 250/0.1)", border: cvs.some(c=>c.threadId===currentThread.id&&c.hired) ? "2px solid oklch(0.72 0.19 160/0.4)" : "1px solid oklch(0.50 0.10 250/0.3)" }}>
                      {(() => {
                        const hiredCV = cvs.find(c=>c.threadId===currentThread.id&&c.hired);
                        if (hiredCV) return <><CheckCircle2 size={20} style={{ color:"oklch(0.78 0.19 160)" }}/><div><div style={{ fontFamily:"var(--grl-font-display)", fontSize:"0.875rem", color:"oklch(0.78 0.19 160)" }}>✅ კანდიდატი <strong>{hiredCV.author}</strong> აყვანილია — CV-ები აღარ მიიღება</div>{hiredCV.hiredBy && <div style={{ fontSize:"0.75rem", fontWeight:400, marginTop:"0.25rem", opacity:0.75 }}>ადმინი: {hiredCV.hiredBy} · {hiredCV.hiredAt ? new Date(hiredCV.hiredAt).toLocaleString("ka-GE") : ""}</div>}</div></>;
                        return <><Lock size={20}/><div><div style={{ fontFamily:"var(--grl-font-display)", fontSize:"0.875rem" }}>🔒 ვაკანსია დახურულია</div><div style={{ fontSize:"0.75rem", fontWeight:400, marginTop:"0.25rem", opacity:0.85 }}>CV-ები აღარ მიიღება</div></div></>;
                      })()}
                    </div>
                  )}
            ...
            <aside className="grl-sidebar-sticky" style={{ display:"flex", flexDirection:"column", gap:"1.25rem" }}>
                ...
                <div style={{ position:"relative" }}>
                  ...
                  <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"0.875rem" }}>
                    {[[forumStats.members,"ფორუმის წევრი"],[forumStats.posts,"საერთო პოსტი"]].map(([num,label]) => (
                      <div key={label}><div style={{ fontSize:"1.375rem", color:"oklch(0.97 0.005 250)", fontWeight:700, fontFamily:"var(--grl-font-display)" }}>{num>=1000?`${(num/1000).toFixed(1)}K`:num}</div><div style={{ fontSize:"0.52rem", textTransform:"uppercase", letterSpacing:"0.1em", color:"var(--grl-muted-foreground)", fontWeight:600, marginTop:"0.2rem" }}>{label}</div></div>
                    ))}
                  </div>
                </div>
              </div>
              ...
              {currentUser && (
                <div className="grl-card" style={{ overflow:"hidden" }}>
                  <div className="grl-sidebar-header">
                    <span style={{ fontFamily:"var(--grl-font-display)", fontSize:"0.7rem", textTransform:"uppercase", color:"var(--grl-foreground)", letterSpacing:"0.2em", fontWeight:700, display:"flex", alignItems:"center", gap:"0.5rem" }}><User size={14}/> ანგარიში</span>
                    <button onClick={handleLogout} style={{ background:"none", border:"none", cursor:"pointer", color:"var(--grl-muted-foreground)", display:"flex", alignItems:"center", gap:"0.25rem", fontSize:"0.6rem", fontWeight:700 }} title="გასვლა"><LogOut size={12}/></button>
                  </div>
                  <div style={{ padding:"1rem", display:"flex", alignItems:"center", gap:"0.75rem" }}>
                    <div style={{ width:40, height:40, borderRadius:"50%", background:currentUser.avatarBg, display:"flex", alignItems:"center", justifyContent:"center", color:"#fff", fontSize:"0.875rem", fontWeight:700, flexShrink:0 }}>{currentUser.username[0].toUpperCase()}</div>
                    <div style={{ minWidth:0 }}>
                      <div style={{ fontWeight:700, fontSize:"0.8rem" }}>{currentUser.username}</div>
                      <span style={{ fontSize:"0.6rem", display:"inline-block", padding:"0.1rem 0.5rem", borderRadius:"999px", background:`${getRoleColor(currentUser)}15`, border:`1px solid ${getRoleColor(currentUser)}33`, color:getRoleColor(currentUser), fontWeight:700 }}>{getRoleLabel(currentUser)}</span>
                    </div>
                  </div>
                </div>
              )}
                ...
                <div style={{ padding:"1rem", display:"flex", flexDirection:"column", gap:"0.875rem" }}>
                  {latestActivity.length === 0 ? (
                    <div style={{ textAlign:"center", padding:"1.5rem 0.5rem" }}>
                      ...
                      <p style={{ fontSize:"0.65rem", color:"var(--grl-muted-foreground)", opacity:0.6, lineHeight:1.5 }}>თემები ჯერ არ არის.</p>
                    </div>
                  ) : (
                    latestActivity.map(t => {
                      const isHired = t.isVacancy && cvs.some(c=>c.threadId===t.id&&c.hired);
                      return (
                        <div key={t.id} onClick={()=>navThread(t.subforumId,t.id)} style={{ display:"flex", alignItems:"flex-start", gap:"0.625rem", cursor:"pointer", padding:"0.3rem 0.4rem", margin:"0 -0.4rem", borderRadius:"0.4rem", transition:"background 0.2s" }} onMouseEnter={e=>e.currentTarget.style.background="oklch(0.68 0.24 0/0.05)"} onMouseLeave={e=>e.currentTarget.style.background="transparent"}>
                          <div style={{ width:28, height:28, borderRadius:"50%", background:t.avatarBg, flexShrink:0, display:"flex", alignItems:"center", justifyContent:"center", color:"#fff", fontSize:"0.6rem", fontWeight:700, outline:"2px solid var(--grl-border)" }}>{t.author[0].toUpperCase()}</div>
                          <div style={{ minWidth:0 }}>
                            ...
                            <p style={{ fontSize:"0.575rem", color:"var(--grl-muted-foreground)", marginTop:"0.1rem" }}>
                              <span style={{ color:"oklch(0.97 0.005 250/0.8)", fontWeight:600 }}>{t.author}</span> · {t.posts.length} პოსტი
                              {t.isVacancy && <span className={isHired?"grl-status-label grl-status-label--hired":"grl-vacancy-badge"} style={{ marginLeft:"0.375rem", fontSize:"0.45rem", padding:"0.05rem 0.3rem" }}>{isHired?<><CheckCircle2 size={8}/> აყვანილია</>:<><Briefcase size={8}/></>}</span>}
                            </p>
                          </div>
                        </div>
                      );
              ...
              <div className="grl-card" style={{ overflow:"hidden" }}>
                ...
                <div style={{ padding:"1rem" }}>
                  {onlineMembers.length === 0 ? (
                    <p style={{ fontSize:"0.6rem", color:"var(--grl-muted-foreground)", opacity:0.5, textAlign:"center", padding:"1rem 0" }}>ონლაინ წევრები არ არიან</p>
                  ) : (
                    <div style={{ display:"flex", flexWrap:"wrap", gap:"0.375rem" }}>
                      {onlineMembers.map((m,i) => (
                        <span key={i} style={{ fontSize:"0.65rem", fontWeight:700, padding:"0.25rem 0.625rem", borderRadius:"0.625rem", border:"1px solid var(--grl-border)", background:m===currentUser?.username?"oklch(0.68 0.24 0/0.15)":"var(--grl-card)", color:m===currentUser?.username?"var(--grl-primary)":"var(--grl-foreground)" }}>{m}{m===currentUser?.username?" (შენ)":""}</span>
                      ))}
                    </div>
                  )}
                </div>
              ...
              <div className="grl-card" style={{ overflow:"hidden", border:"1px solid oklch(0.72 0.22 0/0.3)" }}>
                <div className="grl-sidebar-header" style={{ background:"linear-gradient(to right, oklch(0.72 0.22 0/0.08), transparent)" }}>
                  <span style={{ fontFamily:"var(--grl-font-display)", fontSize:"0.7rem", textTransform:"uppercase", color:"oklch(0.85 0.16 0)", letterSpacing:"0.2em", fontWeight:700, display:"flex", alignItems:"center", gap:"0.4rem" }}><Briefcase size={13}/> ვაკანსიები</span>
                  <span style={{ fontSize:"0.55rem", color:"var(--grl-primary)", fontWeight:700, padding:"0.1rem 0.4rem", borderRadius:"999px", background:"oklch(0.72 0.22 0/0.1)", border:"1px solid oklch(0.72 0.22 0/0.3)" }}>{threads.filter(t=>t.isVacancy&&!t.isClosed).length} ღია</span>
                </div>
                <div style={{ padding:"0.875rem" }}>
                  {threads.filter(t=>t.isVacancy&&!t.isClosed).length === 0 ? (
                    ...
                    threads.filter(t=>t.isVacancy&&!t.isClosed).slice(0,3).map(t => {
                      const threadCvs = cvs.filter(c=>c.threadId===t.id);
                      return (
                        <div key={t.id} onClick={()=>navThread(t.subforumId,t.id)} style={{ cursor:"pointer", padding:"0.5rem", borderRadius:"0.5rem", marginBottom:"0.375rem", transition:"background 0.2s" }} onMouseEnter={e=>e.currentTarget.style.background="oklch(0.72 0.22 0/0.07)"} onMouseLeave={e=>e.currentTarget.style.background="transparent"}>
                          ...
                          <div style={{ fontSize:"0.55rem", color:"var(--grl-muted-foreground)", marginTop:"0.1rem" }}>{threadCvs.length} CV · {t.date}</div>
                        </div>
                      );
                    })
                  )}
                  <button onClick={()=>navSubforum("vacancies")} className="grl-btn grl-btn-sm" style={{ width:"100%", marginTop:"0.5rem", background:"oklch(0.72 0.22 0/0.08)", color:"var(--grl-primary)", border:"1px solid oklch(0.72 0.22 0/0.25)", fontSize:"0.65rem" }}>ყველა ვაკანსია →</button>
                </div>
              </div>
            </aside>
          </div>
        ...
        {isModalOpen && (
          <div className="grl-modal-overlay" onClick={e=>e.target===e.currentTarget&&setIsModalOpen(false)}>
            <div className="grl-card grl-card-3xl grl-animate-fadein" style={{ width:"100%", maxWidth:"36rem", padding:"1.75rem", position:"relative", boxShadow:"0 25px 60px oklch(0 0 0/0.5)", border:isVacancySubforum(currentSubforumId)?"1px solid oklch(0.72 0.22 0/0.3)":undefined }}>
              {isVacancySubforum(currentSubforumId) && <div style={{ position:"absolute", top:0, left:0, right:0, height:2, background:"linear-gradient(90deg, transparent, oklch(0.72 0.22 0/0.8), oklch(0.78 0.14 220/0.6), transparent)", borderRadius:"1.5rem 1.5rem 0 0" }}/>}
              <h3 style={{ fontSize:"1rem", color:isVacancySubforum(currentSubforumId)?"oklch(0.85 0.16 0)":"oklch(0.97 0.005 250)", textTransform:"uppercase", letterSpacing:"0.05em", marginBottom:"1.25rem", paddingBottom:"0.75rem", borderBottom:"1px solid var(--grl-border)", fontFamily:"var(--grl-font-display)", display:"flex", alignItems:"center", gap:"0.5rem" }}>
                {isVacancySubforum(currentSubforumId) ? <><Briefcase size={18}/> ვაკანსიის გამოქვეყნება</> : <>ახალი თემის შექმნა — {currentSubforum?.title}</>}
              </h3>
              <div style={{ display:"flex", flexDirection:"column", gap:"1.125rem" }}>
                <div>
                  <label className="grl-label">{isVacancySubforum(currentSubforumId) ? "ვაკანსიის სახელი / პოზიცია" : "სათაური"}</label>
                  <input type="text" value={newThreadTitle} onChange={e=>setNewThreadTitle(e.target.value)} placeholder={isVacancySubforum(currentSubforumId)?"მაგ: ადმინისტრატორი (TEC) — ვაკანსია":"მაგ: ახალი განახლება"} className="grl-input"/>
                </div>
                <div>
                  <label className="grl-label">{isVacancySubforum(currentSubforumId) ? "კრიტერიუმები და მოთხოვნები" : "შინაარსი"}</label>
                  <textarea rows={isVacancySubforum(currentSubforumId)?6:5} value={newThreadContent} onChange={e=>setNewThreadContent(e.target.value)} placeholder={isVacancySubforum(currentSubforumId)?"მაგ:\n• მინ. ასაკი: 16\n• გამოცდილება: 6+ თვე\n• ენა: ქართული":"დეტალურად აღწერეთ…"} className="grl-input"/>
                </div>
